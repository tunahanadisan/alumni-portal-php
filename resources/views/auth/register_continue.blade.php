  ...
  <div class="col-lg-5">
   <form action={{url('registerControl')}} method="POST" id="form">
     ...
     <div class="register-area">
         ...
         <small>Surname</small>
         <input type="text" name="sur_name" class="form-control" placeholder="*Surname..." value="{{old('sur_name')}}">
         <small>Email</small>
         <input type="text" name="email" id="email"class="form-control" placeholder="*example@mail.com" value="{{old('email')}}">
         <small>Birth Date</small>
         <input type="date" name="birth_date" class="form-control"  value="2018-01-01">
         <small>School start date:</small>
         <input type="date" name="start_date" class="form-control" value="2018-01-01">
         <small>Graduated date:</small>
         <input type="date" name="graduated_date" class="form-control"  value="2018-01-01">
         <small>Department</small>
         <input type="text" name="department" class="form-control" placeholder="Ex: Computer Engineering..." value={{old('department')}}>
         <small>Country</small>
         <select class="form-control" name="country">
             ...
             <hr>
             @if(isset($Rdata))
             <input type="hidden" name="school_id" id="school_id" value="{{$Rdata['school_id']}}">
             <input type="hidden" name="identity_id"  value="{{$Rdata['identify_id']}}">
             @endif
             @if($errors->any())
